...
vector<string> getSuitableWords(const vector<string> &wordList, const string &secretWord,
...
{
    static vector<string> wordList = readWordListFromFile("data/All.txt");
